...
print("\n===================================")
print("GAN DELAYED MORPHOLOGICAL ANALYSIS")
print("===================================\n")
...
for file in tqdm(mask_files):
    ...
    try:
        ...
        distance = create_distance_map(
            mask
        )

        thickness = create_thickness_map(
            distance
        )
...
print("\n===================================")
print("GAN MORPHOLOGICAL ANALYSIS COMPLETE")
print("===================================")
print(
    f"Subjects Found     : {len(mask_files)}"
)
print(
    f"Subjects Processed : {len(df)}"
)
print(
    f"Failed             : {failed}"
)
...
print(
    f"Skeletons          : {SKELETON_DIR}"
)
print(
    f"Thickness Maps     : {THICKNESS_DIR}"
)
print(
